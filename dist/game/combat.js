...
function canAttack(playerCooldown) {
...
function knockbackPlayer(player, direction) {
...
function updateHealthDisplay(elementId, currentHP, maxHP) {
    const healthBar = document.querySelector(`#${elementId} .health-fill`);
    if (healthBar) {
...
export function initiateAttack(player) {
