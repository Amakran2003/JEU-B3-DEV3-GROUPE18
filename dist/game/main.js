...
import { updateCombat, initCombat } from './combat.js'; // Importer le système de combat
...
export function updateGameStatus(player1Lives, player2Lives) {
...
export function gameLoop(currentTime = 0) {
