...
export function update_player() {
    ...
    function handlePlayer(player, keysLeft, keysRight, playerJumpRequested) {
        ...
        const onPlatform = (feetY >= platTop - 15 && feetY <= platTop + 35 &&
        ...
        const onSpikes = ((hitboxLeft < platLeft || hitboxRight > platRight) &&
        ...
        // Comportement normal (joueur vivant)
            ...
            // En l'air
                ...
                const willLandOnPlatform = (nextFeetY >= platTop - 5 &&
